...
for dataset in dataset_list:
    for defence in defence_list:
        for petar in model_list[defence]:
            os.system("python predict.py --dataset {} --model {}".format(dataset, petar))
            os.system("python predict.py --dataset {} --model {} --istarget".format(dataset, petar[:-4]+"_shadow.pth"))
